...
export default function PageNavigation({ them = 'dark' }: IProps) {
  ...
  return (
    <nav className={clsx('mx-auto', them === 'light' && 'mr-0')}>
      <ul className={clsx("flex gap-10 font-medium select-none text-sm", them === 'light' ? "max-2xs:flex-col max-2xs:items-center" : "max-sm:hidden")}>
