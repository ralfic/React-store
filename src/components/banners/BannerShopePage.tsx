...
export default function BannerShopePage() {
  return (
    <article className="font-Poppins  py-48  w-full bg-banner-fon-shope max-lg:py-38 max-md:py-32 max-w-wrapper mx-auto bg-no-repeat bg-cover">
      <div className="max-w-[413px] mx-auto flex flex-col gap-6 items-center justify-center">
        <BreadcrumbRoot colorPalette={'white'} size={'lg'}>
          ...
          <BreadcrumbCurrentLink className='dark:text-violet-500'>Shope</BreadcrumbCurrentLink>
        </BreadcrumbRoot>
